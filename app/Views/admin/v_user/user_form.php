            ...
            <div class="card-body" style="overflow: scroll;">
                ...
                <form action="<?=site_url().$form?>" method="post">
                    ...
                    <div class="position-relative row form-group"><label for="exampleEmail"
                        ...
                        <div class="col-sm-10"><input name="email" id="exampleEmail" type="email" class="form-control"
                                value="<?=$email?>">
                    ...
                    <div class="position-relative row form-group"><label for="exampleSelect"
                            class="col-sm-2 col-form-label">Level User</label>
                        <div class="col-sm-10"><select name="id_level" id="examplelevel" class="form-control">
                                <option value="-">-Pilih Level-</option>
                                <?php $i = 1; foreach ($level as $l): ?>
                                <option <?php if ($l['id_level']==$levelid) { echo 'selected';} ?>
                                    value="<?=$l['id_level'];?>"><?=$l['level'];?></option>
                                <?php $i++;endforeach;?>
                            </select>
                        </div>
                    </div>
